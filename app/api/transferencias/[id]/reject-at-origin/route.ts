...
// POST /api/transferencias/[id]/reject-at-origin
// Líder da origem recusa a indicação; volta a Transfer para PENDING.
// Body: { reason: string }
...
export async function POST(
  ...
  try {
    ...
    const status = /AWAITING_APPROVAL|fromStoreId/i.test(msg) ? 422 : 500;
