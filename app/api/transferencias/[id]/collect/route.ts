...
// POST /api/transferencias/[id]/collect
// Motorista coleta na origem com foto.
// Body: { photoUrl: string (URL), photoPath: string }
...
export async function POST(
  ...
  try {
    ...
    const status = /READY_TO_COLLECT/.test(msg) ? 422 : 500;
